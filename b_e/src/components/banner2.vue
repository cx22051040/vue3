<template>
    ...
    >
      ...
      <el-icon class="left-button" @click="switchBanner('left')"><ArrowLeft /></el-icon>
      <el-icon class="right-button" @click="switchBanner('right')"><ArrowRight /></el-icon>
  ...
  const loadImages = () => {
    const images = [];
    for (let i = 1; i <= 5; i++) { // Assuming you have 10 images
      images.push({
        img: new URL(`../static/${i}.jpg`, import.meta.url).href,
        description: `Image ${i}`
      });
    }
